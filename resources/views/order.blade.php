            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Online Order</h1>
                        <p class="mb-4">Warung Millenial berkolaborasi dengan berbagai aplikasi seperti Gofood, ShoopeFood, GrabFood.</p>
                        <p class="mb-4">Kalian bisa memesan menu menu yang telah tersedia diberbagai aplikasi tersebut.</p>
                    </div>
                </div>
            </div>
        </div>
